...
const userSchema = new mongoose.Schema({
    name: {
        ...
        maxLength: [40, 'Name Too Large'], minLength: [0, 'Name Too Small']
        //validate: [validator.isAlpha, 'Tour Name Should Not Have Numbers']
    },
    channelName: {
        type: String, trim: true, default: 'Channel'
    },
...
=======
        //maxLength: [10, 'Invalid Phone Number'], minLength: [10, 'Invalid Phone Number']
>>>>>>> 177256a5a5f2dc663066681b3c753142b66aa32b
    },
    role: { type: String, enum: ['user', 'admin'], default: 'user' },
    password: {
        type: String, required: [true, 'Password is Required'],
        minLength: [8, 'Password Too Small'], select: false
    },
    passwordConfirm: {
        type: String, required: [true, 'Comfirm Password is Required'],
        minLength: [8, 'Password Too Small'], select: false,
        validate: {
